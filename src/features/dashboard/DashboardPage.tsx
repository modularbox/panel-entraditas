...
export function DashboardPage() {
  ...
  // "Ordenar por" de la tabla de eventos. Van antes de los `return` de abajo: un hook después de un
  // return condicional cambia el orden de los hooks entre renders y React se rompe.
  const [criterio, setCriterio] = useState<CriterioDeOrden>("grossRevenue");
  const [sentido, setSentido] = useState<SentidoDeOrden>("desc");
