...
export function createSeedDatabase(): Database {
  ...
  const event1TicketType: TicketType = {
    ...
    name: "General", kind: "pago", basePrice: 2500, currency: "EUR", quantityTotal: 400, quantitySold: 0,
  ...
  const event2TicketTypePista: TicketType = {
    ...
    name: "Pista", kind: "pago", basePrice: 3000, currency: "EUR", quantityTotal: 800, quantitySold: 0,
    minPerOrder: 1, maxPerOrder: 6, visibility: "public", isTransferable: true, isRefundable: true, sortOrder: 0,
    color: null
  };
  const event2TicketTypeGrada: TicketType = {
    ...
    name: "Grada VIP", kind: "pago", basePrice: 5000, currency: "EUR", quantityTotal: 400, quantitySold: 0,
  ...
  const event4PassTicketType: TicketType = {
    ...
    name: "Abono 3 días", kind: "abono", basePrice: 9000, currency: "EUR", quantityTotal: 1500, quantitySold: 0,
